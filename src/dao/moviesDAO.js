...
export default class MoviesDAO {
  ...
  static async getMoviesByCountry(countries) {	
    ...
    */
	let countriesList3 = [];
	//countriesList3 = countries.split(", "); 
	console.log('vin-prAT countries list ',countries);
	console.log('vin-prAT countriesList3 ',countriesList3);
    ...
    try {
      ...
      //cursor = await movies.find( { countries:{$in :countries} },{title:1})
				//await movies.find({countries : {$in : countries} }).project({ title: 1 })
